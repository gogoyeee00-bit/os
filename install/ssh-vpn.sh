...
REPO2="https://raw.githubusercontent.com/gogoyeee00-bit/os/main/"
# initializing var
...
wget -O /etc/haproxy/haproxy.cfg "https://raw.githubusercontent.com/gogoyeee00-bit/os/main/install/haproxy.cfg"
